...
const Chat = () => {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50">
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="absolute bottom-20 right-0 w-72 bg-white rounded-lg shadow-xl border border-gray-200">
                    {/* Header */}
                    <div className="bg-green-500 p-4 rounded-t-lg">
                        <h3 className="text-white font-semibold">Chat with us</h3>
                        <p className="text-green-100 text-sm">Send us a message</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-4">
                        <textarea
                            ...
                            className="w-full p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-green-500 resize-none"
                            rows="4"
                        />
                        <button
                            type="submit"
